...
testPermissionRouter.get('/Write', hasPermission("Write"), testPermissionController.writePermissionTest);
testPermissionRouter.get('/Read', hasPermission("Read"), testPermissionController.readPermissionTest);